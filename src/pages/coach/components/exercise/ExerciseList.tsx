                        ...
                        <td className="border p-2">
                            <div className="flex justify-center space-x-2">
                                <button
                                    ...
                                    className="bg-blue-500 hover:bg-blue-600 w-auto flex items-center justify-center gap-4 text-white font-bold py-2 px-4 rounded transition duration-300"
                                >
                                ...
                                <button
                                    ...
                                    className="bg-green-500 hover:bg-green-600 w-auto flex items-center justify-center gap-4 text-white font-bold py-2 px-4 rounded transition duration-300"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <button
                                    ...
                                    className="bg-red-500 hover:bg-red-600 w-auto flex items-center justify-center gap-4 text-white font-bold py-2 px-4 rounded transition duration-300"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
